 ...
 *     a usable DMA path. Pair this module with a companion mdev driver to
 ...
 *
 * Hotplug emulation:
 *   /sys/class/fake_pci/control/hotplug_control accepts "hide" / "show"
 *   to simulate device disappear / reappear, enabling tests of
 *   virt-handler's hot-plug detection.
 */
...
#define FAKE_PCI_CLASS_NAME     "fake_pci"
